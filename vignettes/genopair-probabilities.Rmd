...
# Combine genopair probabilities for selected kinships
pss_gp_prbs_kps = array(
...
# Save for other vignettes
save(pss_gp_prbs_kps, file = "../data/possible_genopair_probabilities.RData")
```
